			...
			<div class="in-check" >
				...
				<ul class="cart-header">
					<div class="close1"> </div>
						<li class="ring-in"><a href="${pageContext.request.contextPath}/single.html" ><img src="${pageContext.request.contextPath}/images/s-1.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span>Woo Dress</span></li>
						<li><span>$ 290.00</span></li>
						<li><span>In Stock</span></li>
						<li> <a href="${pageContext.request.contextPath}/single.html" class="add-cart cart-check">ADD TO CART</a></li>
					<div class="clearfix"> </div>
				</ul>
				<ul class=" cart-header1">
					<div class="close2"> </div>
						<li class="ring-in"><a href="${pageContext.request.contextPath}/single.html" ><img src="${pageContext.request.contextPath}/images/s-2.jpg" class="img-responsive" alt=""></a>
						</li>
				...
				<ul class="cart-header2">
					<div class="close3"> </div>
						<li class="ring-in"><a href="${pageContext.request.contextPath}/single.html" ><img src="${pageContext.request.contextPath}/images/s-4.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span>Woo Dress</span></li>
